...
<body id="kt_body" class="app-blank">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
                    ...
                    <div class="py-20">
                        ...
                        <form class="form w-100" action="<?= base_url('login') ?>" method="post">
                            <div class="text-start mb-10">
                                <h1 class="text-gray-900 mb-3 fs-3x" data-kt-translate="sign-up-title">Sign in as member</h1>
            ...
            <!--end::Aside-->
            <!--begin::Body-->
            <div class="d-none d-lg-flex flex-lg-row-fluid w-50 bgi-size-cover bgi-position-y-center bgi-position-x-start bgi-no-repeat" style="background-image: url(<?= base_url() ?>assetss/media/auth/7.png)"></div>
            <!--begin::Body-->
        </div>
